  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mr-1">Efectos:</span>
        {[
          { label: "A＋", desc: "Activo sube", cls: "bg-emerald-100 text-emerald-700 border-emerald-200" },
          { label: "A－", desc: "Activo baja", cls: "bg-rose-100 text-rose-700 border-rose-200" },
          { label: "P＋", desc: "Pasivo sube", cls: "bg-orange-100 text-orange-700 border-orange-200" },
          { label: "P－", desc: "Pasivo baja", cls: "bg-emerald-100 text-emerald-700 border-emerald-200" },
          { label: "C＋", desc: "Patrimonio sube", cls: "bg-violet-100 text-violet-700 border-violet-200" },
          { label: "C－", desc: "Patrimonio baja", cls: "bg-rose-100 text-rose-700 border-rose-200" },
          { label: "I＋", desc: "Ingreso sube", cls: "bg-blue-100 text-blue-700 border-blue-200" },
          { label: "G＋", desc: "Gasto sube", cls: "bg-rose-100 text-rose-700 border-rose-200" },
          { label: "G－", desc: "Gasto baja", cls: "bg-emerald-100 text-emerald-700 border-emerald-200" },
        ].map(({ label, desc, cls }) => (
          <span key={label} title={desc}
            className={`text-xs font-mono font-bold px-1.5 py-0.5 rounded border cursor-default ${cls}`}>
            {label}
          </span>
        ))}
      </div>
